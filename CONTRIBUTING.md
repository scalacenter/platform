...
This project adheres to the Scala Center Code of Conduct. With your contributions,
you're only expected to uphold this code. Please, report unacceptable behaviour to
[the Scala Center gitter channel](https://gitter.im/scala/center) or privately to
any Scala Center engineer.

All human interaction is codified in the [Scala Platform C4 contract](c4).
In short, it ensures that you, as a contributor, will receive a respectable
treatment from any member of our Community.

We're looking forward to your contributions and hope to make you feel part of
this family. Have fun!

# The Scala Platform C4 contract
<a name="c4"></a>
